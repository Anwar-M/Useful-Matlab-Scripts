...
% used which changes during the loop, floats, strings, a timer, etc. 
% Just remember the proper formatting.
...
for I = 1:total_loops
    ...
    fprintf([reverseStr, msg]); % Essential, include string and deletion of previous
    reverseStr = repmat(sprintf('\b'), 1, length(msg)); % Essential, construct deletion of previous
